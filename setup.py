...
#
#     from MinmlDB import metadata
#
# However, when we do this, we also import `MinmlDB/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'MinmlDB_cli = MinmlDB.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'MinmlDB_gui = MinmlDB.gui:entry_point'
        # ]
    }
)
